...
<body>
    ...
    <div class="mainContent">
        ...
        <div class="position">
            ...
            ?>
            <?php
            $selectEvents = "SELECT * FROM evenimente ORDER BY data DESC LIMIT 24";
            ...
            if ($resultSelectEvents) {
                while ($row = mysqli_fetch_assoc($resultSelectEvents)) {
                    ...
                    if (strlen($row["descriere"]) > 480) {
                        $descriereEvent = substr($row["descriere"], 0, 380) . "...";
                    } else {
            ...
            if ($exist == false) {
                echo '<div style="font-size:5vh;margin-top:10vh;">Momentan, nu exsită evenimente încheiate!</div>';
            } ?>
